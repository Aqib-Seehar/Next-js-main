...
const MapPinIcon = (props) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M12 2a8 8 0 0 0-8 8c0 5.428 5.767 9.873 8 13.5 2.233-3.627 8-8.072 8-13.5a8 8 0 0 0-8-8zm0 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"
      clipRule="evenodd"
    />
  </svg>
);
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-gray-200 h-full min-h-[250px] w-full border border-gray-300 rounded overflow-hidden">
            ...
            <div className="relative h-full w-full">
              <div className="relative rounded-lg  border border-gray-200 w-full h-[400px]  flex items-center justify-center">
                <img
                  src="/images/google.png "// Using the public path here
                  alt="Google map"
